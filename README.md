...
## 第3条（個人情報の収集・利用する目的）
本サービスではユーザーの個人情報を収集する可能性のある以下のサードパーティのサービスを使用しています。
...
利用目的の変更を行った場合には，変更後の目的について，運営所定の方法により，ユーザーに通知し，または本サービス内に公表するものとします。
...
## 第9条 (他サイトへのリンク)
本サービスには他サイトへのリンクが含まれる場合があります。サードパーティのリンクをクリックすると、本サービスの運営外となり本ポリシーの適応外となります。
